...
<body>
	...
	<h1 style="color: green; font-size: 40px;" align="center">Hi Friends bharath here</h1>
	...
	<h1 style="color: red; font-size: 40px;" align="center">WELCOME TO Bharath platform</h1>
